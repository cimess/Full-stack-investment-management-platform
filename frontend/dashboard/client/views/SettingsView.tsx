  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="glass-panel rounded-2xl border border-white/5 overflow-hidden">
          ...
          <div className="p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-blue-600 flex items-center justify-center text-3xl font-bold text-white shadow-lg">
              A
            </div>
            <div className="flex-1 space-y-4 w-full">
              ...
              <div className="flex justify-end">
                <button className="px-5 py-2 bg-white/5 text-white text-xs font-bold rounded-lg border border-white/10 hover:bg-white/10 transition-colors">
                  Update Profile
                </button>
              </div>
            </div>
      ...
      <div className="flex justify-end pt-4">
         <button className="px-8 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
            Save Changes
         </button>
      </div>
    </div>
