                  ...
                  {rowItems.map((s: any, index: any) => {
                    ...
                    return (
                      <div
                        ...
                        className="premium-card p-4 sm:p-5 cursor-pointer hover:-translate-y-1 transition-all group flex flex-col justify-between border border-white/5 hover:border-emerald-500/30 mb-2 sm:mb-0 border-b md:border-b-transparent border-white/5"
                      >
