    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div>
          ...
          <div className="flex bg-white/5 p-1 rounded-xl mt-4 w-fit border border-white/10">
            <button 
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 md:w-80">
            ...
            <input
              ...
              className="bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-emerald-500/50 w-full transition-all"
            />
          </div>
          ...
          {!isSearchActive && (
            <div className="relative">
              <button 
                ...
                className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-slate-400 hover:text-white hover:border-white/20 transition-all flex items-center gap-2"
              >
                  ...
                  {rowItems.map((s: any, index: any) => {
                    ...
                    return (
                      <div
                        ...
                        className="premium-card p-5 cursor-pointer hover:-translate-y-1 transition-all group flex flex-col justify-between border border-white/5 hover:border-emerald-500/30"
                      >
